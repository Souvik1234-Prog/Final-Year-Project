...
# Load the CSV file with details
...
if uploaded_file is not None:
    ...
    # Show details if class is found
    plant_details = df[df['Name'] == class_names[predicted_class]]
    if not plant_details.empty:
        st.subheader("Plant Details:")
        st.write(plant_details)
    else:
        st.write("No details found for this plant.")
